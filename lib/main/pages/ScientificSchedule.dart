...
class Scientificschedule extends StatefulWidget
{
  const Scientificschedule({super.key});
  @override
  State<Scientificschedule> createState() => _ScientificscheduleState();

}


class _ScientificscheduleState extends State<Scientificschedule> with SingleTickerProviderStateMixin {
